...
add_arg('annotation_path',      str,  'dataset1/annotation/',      '标注文件的路径')
add_arg('save_audio_path',      str,  'dataset1/audio/merge_audio','合并音频的保存路径')
add_arg('max_test_manifest',    int,  10000,        '兼容旧版的保留参数；发布版严格沿用官方train/dev/test划分，不再重新抽取测试集')
